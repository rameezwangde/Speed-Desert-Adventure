...
export default function HourlyPackages() {
  ...
  return (
    <section className="hourly-section">
      <SectionHeading eyebrow={t('hourly.eyebrow')} title={t('hourly.title')} accent={t('hourly.accent')} align="center" />
