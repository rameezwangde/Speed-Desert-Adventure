      ...
      <div className="pb-content">
        ...
        <div className="pb-center">
          <div className="pb-eyebrow">
            ...
            <h3>{t('paymentBanner.eyebrow')}</h3>
            <span className="pb-line"></span>
          </div>
          <h2>{t('paymentBanner.title')} <span>{t('paymentBanner.titleAccent')}</span></h2>
          ...
          <div className="pb-features">
            <div className="pb-feature">
              ...
              <span>{t('paymentBanner.noHiddenFees')}</span>
            </div>
            <div className="pb-feature">
              ...
              <span>{t('paymentBanner.transparent')}</span>
            </div>
            <div className="pb-feature">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
              <span>{t('paymentBanner.fastBooking')}</span>
            </div>
          </div>
        </div>

        <div className="pb-action">
          <a href="https://wa.me/971504799258" target="_blank" rel="noreferrer" className="pb-whatsapp-btn">
            ...
            <span>{t('paymentBanner.whatsappUs')}</span>
          </a>
        </div>
      </div>
    </section>
