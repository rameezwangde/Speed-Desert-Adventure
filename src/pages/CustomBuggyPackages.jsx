...
const tourInfo = [
  ...
  '1-Hour Drive',
  'Customized Dune Buggy Adventure',
  'Private Buggies',
    ...
    <main className="tour-details-page">
      <section className="td-hero">
        ...
        <div className="td-hero-header">
          <SectionHeading eyebrow="CUSTOM" title="BUGGY PACKAGES" accent="IN DUBAI" align="center" />
      ...
      <section className="td-content-section">
        <div className="td-main-content">
          <SectionHeading eyebrow="Experience" title="Custom Buggy" accent="Packages" />
          
          <div className="td-text-blocks">
            <p>Make your desert adventure truly one of a kind with our <strong>Custom Buggy Packages</strong>. Whether you're celebrating a special occasion, hosting an event, or simply want something extra memorable, we'll tailor every detail to match your vision.</p>
            <p>Just share your ideas, requests, or special needs — and we'll craft a desert experience that's all about you.</p>
            <p>Enjoy private buggies, a dedicated personal guide, and customizable routes that let you explore the dunes exactly how you want.</p>
            <p>From romantic escapes to high-energy celebrations, our team uses years of expertise to design an unforgettable buggy adventure that you and your guests will cherish long after the ride.</p>
          </div>
        </div>
      ...
      <section className="td-ticket-prices" style={{ padding: '0 5%', maxWidth: '1200px', margin: '40px auto 0' }}>
        <SectionHeading title="Custom Buggy" accent="Ticket Price & Timing" align="center" />
        <div className="table-wrapper td-table" style={{ maxWidth: '800px', margin: '40px auto 0' }}>
          <table className="custom-table" style={{ width: '100%', minWidth: '100%', borderCollapse: 'collapse', border: '1px solid rgba(255,255,255,0.1)' }}>
            <tbody>
              <tr>
                <td style={{ padding: '20px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}><strong>Custom Buggy Package</strong></td>
