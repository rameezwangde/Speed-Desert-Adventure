...
const packages = [
  ...
  { name: 'Can-Am Maverick XR MAX (245 HP Stage 4)', seats: '2 & 4 Seater', time: '60 min / 2 hrs', price: 'AED 1000 (1 Hr) - 1800 (2 Hrs)' },
      ...
      <section className="td-hero">
        ...
        <div className="td-hero-header">
          ...
          <div className="td-hero-price">
            <span className="price-label">{formatPriceString('From AED 700')}</span>
